...
- [Running Custom Code on a Google Home Mini (Part 2)](https://courk.cc/running-custom-code-google-home-mini-part2)
- [Smart Spies: Alexa and Google Home expose users to vishing and eavesdropping](https://www.srlabs.de/bites/smart-spies)
